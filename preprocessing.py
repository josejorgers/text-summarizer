...
contraction_mapping = {"ain't": "is not", "aren't": "are not","can't":
                       "cannot", "'cause": "because", "could've":
                       "could have", "couldn't": "could not",
                       ...
                       "oughtn't": "ought not", "oughtn't've":
                       "ought not have", "shan't": "shall not",
                       "sha'n't": "shall not", "shan't've": "shall not have",
                       "she'd": "she would",
                       "she'd've": "she would have", "she'll":
                       "she will", "she'll've": "she will have",
                       "she's": "she is", "should've": "should have",
                       "shouldn't": "should not",
                       "shouldn't've": "should not have", "so've":"so have",
                       "so's": "so as", "this's": "this is",
                       "that'd": "that would", "that'd've":"that would have", "that's": "that is",
                       "there'd": "there would", "there'd've":
                       "there would have", "there's": "there is",
                       "here's": "here is","they'd": "they would",
                       "they'd've": "they would have", "they'll":
                       "they will", "they'll've": "they will have",
                       ...
                       "would've": "would have",
                       "wouldn't": "would not", "wouldn't've":
                       "would not have", "y'all": "you all",
                       "y'all'd": "you all would","y'all'd've": "you all would have",
                       "y'all're": "you all are","y'all've": "you all have", "you'd":
                       "you would", "you'd've": "you would have",
...
def text_preprocessing(text, flag=False):
    newStr = text.lower()
    newStr = BeautifulSoup(newStr, 'lxml').text
    newStr = re.sub(r'\([^)]*\)', '', newStr)
    newStr = re.sub('"','', newStr)
    newStr = ' '.join([contraction_mapping[t] if t in contraction_mapping else t for t in newStr.split(" ")])    
    newStr = re.sub(r"'s\b","",newStr)
    newStr = re.sub("[^a-zA-Z]", " ", newStr) 
    newStr = re.sub('[m]{2,}', 'mm', newStr)

    if not flag:
        tokens = [w for w in newStr.split() if not w in swords]
    else:
        tokens = newStr.split()
    words = []
